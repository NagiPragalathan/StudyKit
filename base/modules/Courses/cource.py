...
def create_page(Search):
    ...
    link = url(search)
    links = ""
    path = "/home/nagipragalathan/Desktop/StudyKit/templates/cources/school_education"
    contant = Cscrping(search,5,"p")
    head = Cscrping(search,18,"h1")
    Code = ""
    KeyWordToimage(search,13,"/home/nagipragalathan/Desktop/StudyKit/static/cources/school_education")

    Code = Code + "<h1>" + search +"</h1>"
    y = 4
    count = 0
    files = open("/home/nagipragalathan/Desktop/StudyKit/templates/cources/school_education/simple.html","w")
    file = os.listdir(f"/home/nagipragalathan/Desktop/StudyKit/static/cources/school_education/"+search)
